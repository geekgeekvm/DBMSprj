    ...
    <div class="container body">
         ...
         <div class="main_container">
            ...
            <div class="right_col" role="main">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                            ...
                                            <div id="crop-avatar">
                                                ...
                                                <div class="avatar-view" title="Change the picture">
                                                    <?php
                                                     ...
                                                     $temppath=mysql_query("SELECT Path from teacherdb where username='$_SESSION[username]'");
                                                     $imgpath=mysql_fetch_array($temppath);
                                                    echo"<img src='images/".$imgpath[0]."'' alt='Avatar'>";
                                                    ?>
                                                </div>
                                        ...
                                        //session_start();
                                        include("connection.php");
                                        $tempname=mysql_query("SELECT name from teacherdb where username='$_SESSION[username]'");
                                        $name=mysql_fetch_array($tempname);
                                        echo "<h3>".$name[0]."</h3>";
                                         ?>
                                        <ul class="list-unstyled user_data">
                                            <li><i class="fa fa-map-marker user-profile-icon"></i> VI Floor,IT Dept,NITK Surathkal
                                            </li>

                                            <li>
                                                <i class="fa fa-briefcase user-profile-icon"></i> Assistant Lecturer
                                            </li>

                                            <li class="m-top-xs">
                                                <i class="fa fa-external-link user-profile-icon"></i>
                                                <a href="http://cse.nitk.ac.in/faculty/mohit-p-tahiliani" target="_blank">Know more</a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            ...
                                            <div id="myTabContent" class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                                                   <?php
                                                    include("connection.php");
                                                    $tempprofile=mysql_query("SELECT profile from data where username='$_SESSION[username]'");
                                                    $profile=mysql_fetch_array($tempprofile);
                                                    echo"<p>".$profile[0]."</p>";
                                                    ?>
                                                </div>
                                            </div>
                ...
                <footer>
                    <div class="">
                        <p class="pull-right">NITK Student Academic Portal <a>NITK</a>. |
