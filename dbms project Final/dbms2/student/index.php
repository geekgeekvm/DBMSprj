...
$sql="SELECT distinct t.course FROM studentdb s,teacherdb t where  s.sem=t.sem and s.regno=\"$username\"";
$rs=mysql_query($sql,$conn);
$total=mysql_num_rows($rs);

$sql="SELECT distinct sem FROM studentdb where regno=\"$username\" ";
$rs=mysql_query($sql,$conn);
...
$teachers=mysql_num_rows($rs);
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="http://nitk.ac.in" class="site_title"><i class="fa fa-paw"></i> <span>NITK Surathkal</span></a>
                    </div>
                ...
                <div class="">
					...
					<div class="row top_tiles">
                        ...
                        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h3>Semester</h3>
                                <p>Semester no. of <?php echo $_SESSION['username'] ?></p>
                            </div>
                        </div>
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Student Marks(Line graph)<small>Course Vs Marks</small></h2>
                                ...
                                <!--<div>
                                    <canvas id="canvasTraffic" width="100" height="100"></canvas>
                                </div>-->
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Student Marks(Bar graph) <small>Course Vs Marks</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Average Marks (Line graph)<small>Course Vs Average Marks</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Average Marks(Bar graph) <small>Course Vs Average Marks</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
 ...
 $sql="SELECT distinct(t.course) FROM teacherdb t,studentdb s  where s.regno=\"$username\" and s.sem=t.sem order by course";
 $resultf=mysql_query($sql,$conn);

 $sql="SELECT avg(marks) FROM  marksdb  where rollno=\"$username\"  group by course order by course" ;
...
$sql="SELECT distinct(t.course) FROM teacherdb t,studentdb s  where s.regno=\"$username\" and s.sem=t.sem order by course";
 ...
 $sql="SELECT avg(m.marks) FROM marksdb m,teacherdb t,studentdb s where s.sem=t.sem and t.course=m.course and s.regno=\"$username\"  group by m.course order by m.course" ;
