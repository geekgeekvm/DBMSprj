...
<body class="nav-md">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                        ...
                                        <ul class="list-unstyled user_data">
                                            <li><i class="fa fa-map-marker user-profile-icon"></i>IT Dept,NITK Surathkal
                                            </li>
                                            ...
                                            <li class="m-top-xs">
                                                ...
                                                <a href="http://nitk.ac.in" target="_blank">Know more</a>
                                            </li>
                                        </ul>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                    ...
                                                    <table class="data table table-striped no-margin">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>2</td>
                                                                <td>Automata and compiler design</td>
                                                                <td>submitted</td>
                                                            ...
                                                            <tr>
                                                                <td>4</td>
                                                                <td>Distributed Computing system</td>
                                                                <td>Submitted</td>
	...
	<script type="text/javascript" src="../extra/js/wizard/jquery.smartWizard.js"></script>
