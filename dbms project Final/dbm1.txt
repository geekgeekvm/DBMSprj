...
('mohith', 'Received EMC Young Achiever Awards 2015 from EMC Corporation, February 2015.\r\nReviewer for IEEE Communication Letters.\r\nMember of Technical Programme Committee, 6th Workshop on ns-3 (WNS3 2015), CTTC, Barcelona, Spain.\r\nMember of Technical Programme Committee, 5th Workshop on ns-3 (WNS3 2014), Georgia Tech, USA.\r\nReviewer for Journal of Network and Computer Applications (JNCA), Elsevier.\r\nBest Paper Award in International Symposium on Cloud and Service Computing, 2012.\r\nGold medalist in M.Tech, 2009.\r\nReceived Best Student – 2008 Award, EMC Corporation, Bangalore, 2009.\r\n'),
('mohith', 'Received EMC Young Achiever Awards 2015 from EMC Corporation, February 2015.\r\nReviewer for IEEE Communication Letters.\r\nMember of Technical Programme Committee, 6th Workshop on ns-3 (WNS3 2015), CTTC, Barcelona, Spain.\r\nMember of Technical Programme Committee, 5th Workshop on ns-3 (WNS3 2014), Georgia Tech, USA.\r\nReviewer for Journal of Network and Computer Applications (JNCA), Elsevier.\r\nBest Paper Award in International Symposium on Cloud and Service Computing, 2012.\r\nGold medalist in M.Tech, 2009.\r\nReceived Best Student – 2008 Award, EMC Corporation, Bangalore, 2009.\r\n');
...
CREATE TABLE IF NOT EXISTS `marksdb` (
...
INSERT INTO `marksdb` (`rollno`, `marks`, `course`, `exam`) VALUES
('14it101',35,'DBMS','mid'),
('14it102',29,'DBMS','mid'),
('14it103',37,'DBMS','mid'),
('14it104',18,'DBMS','mid'),
...
('14co104', 22, 'OS', 'quiz2'),
('14co105', 24, 'OS', 'quiz2'),
('14it101', 20, 'DBMS', 'project'),
('14it102', 17, 'DBMS', 'project'),
('14it103', 19, 'DBMS', 'project'),
('14it104', 22, 'DBMS', 'project'),
('14it105', 20, 'DBMS', 'project'),
('14it106', 18, 'DBMS', 'project'),
('14it107', 20, 'DBMS', 'project'),
('14it108', 15, 'DBMS', 'project'),
('14it109', 18, 'DBMS', 'project'),
('14it110', 21, 'DBMS', 'project'),
('14it111', 20, 'DBMS', 'project'),
('14it112', 19, 'DBMS', 'project'),
('14it113', 20, 'DBMS', 'project'),
('14it114', 23, 'DBMS', 'project'),
('14it115', 19, 'DBMS', 'project'),
('14it116', 20, 'DBMS', 'project'),
('14it117', 18, 'DBMS', 'project'),
('14it118', 20, 'DBMS', 'project'),
('14it119', 21, 'DBMS', 'project'),
('14it120', 22, 'DBMS', 'project'),
('14it126', 24, 'DBMS', 'project'),
('14it212', 24, 'DBMS', 'project'),
('14it232', 24, 'DBMS', 'project'),
('14it245', 24, 'DBMS', 'project'),
('14it101', 17, 'ACD', 'assgn'),
('14it102', 22, 'ACD', 'assgn'),
('14it103', 14, 'ACD', 'assgn'),
('14it104', 28, 'ACD', 'assgn'),
('14it105', 17, 'ACD', 'assgn'),
('14it106', 9, 'ACD', 'assgn'),
('14it107', 18, 'ACD', 'assgn'),
('14it108', 25, 'ACD', 'assgn'),
('14it109', 19, 'ACD', 'assgn'),
('14it110', 20, 'ACD', 'assgn'),
('14it111', 27, 'ACD', 'assgn'),
('14it112', 11, 'ACD', 'assgn'),
('14it113', 8, 'ACD', 'assgn'),
('14it114', 20, 'ACD', 'assgn'),
('14it115', 11, 'ACD', 'assgn'),
('14it116', 19, 'ACD', 'assgn'),
('14it117', 27, 'ACD', 'assgn'),
('14it118', 30, 'ACD', 'assgn'),
('14it119', 11, 'ACD', 'assgn'),
('14it120', 7, 'ACD', 'assgn'),
('14it101', 18, 'DBMS', 'Assignment'),
('14it102', 25, 'DBMS', 'Assignment'),
('14it103', 21, 'DBMS', 'Assignment'),
('14it104', 26, 'DBMS', 'Assignment'),
('14it105', 14, 'DBMS', 'Assignment'),
('14it106', 15, 'DBMS', 'Assignment'),
('14it107', 20, 'DBMS', 'Assignment'),
('14it108', 18, 'DBMS', 'Assignment'),
('14it109', 19, 'DBMS', 'Assignment'),
('14it110', 14, 'DBMS', 'Assignment'),
('14it111', 15, 'DBMS', 'Assignment'),
('14it112', 14, 'DBMS', 'Assignment'),
('14it113', 17, 'DBMS', 'Assignment'),
('14it114', 21, 'DBMS', 'Assignment'),
('14it115', 21, 'DBMS', 'Assignment'),
('14it116', 20, 'DBMS', 'Assignment'),
('14it117', 8, 'DBMS', 'Assignment'),
('14it118', 14, 'DBMS', 'Assignment'),
('14it119', 4, 'DBMS', 'Assignment'),
('14it120', 22, 'DBMS', 'Assignment'),
('14it126', 23, 'DBMS', 'Assignment'),
('14it212', 24, 'DBMS', 'Assignment'),
('14it232', 23, 'DBMS', 'Assignment'),
('14it245', 23, 'DBMS', 'Assignment'),
('13co101', 18, 'CN', 'Midsem'),
('13co102', 25, 'CN', 'Midsem'),
('13co103', 21, 'CN', 'Midsem'),
('13co104', 26, 'CN', 'Midsem'),
('13co105', 14, 'CN', 'Midsem'),
('13co106', 15, 'CN', 'Midsem'),
('13co107', 20, 'CN', 'Midsem'),
('13co108', 18, 'CN', 'Midsem'),
('13co109', 19, 'CN', 'Midsem'),
('13co110', 14, 'CN', 'Midsem'),
('13co111', 15, 'CN', 'Midsem'),
('13co112', 14, 'CN', 'Midsem'),
('13co113', 17, 'CN', 'Midsem'),
('13co114', 21, 'CN', 'Midsem'),
('13co115', 21, 'CN', 'Midsem'),
('13co116', 20, 'CN', 'Midsem'),
('13co117', 8, 'CN', 'Midsem'),
('13co118', 14, 'CN', 'Midsem'),
('13co119', 4, 'CN', 'Midsem'),
('13co120', 22, 'CN', 'Midsem');
...
INSERT INTO `weightage` (`course`, `exam`, `weightage`) VALUES
('DBMS','mid',50),
('DBMS','mid',50),
('DBMS','mid',50),
('DBMS','mid',50),
...
('14it126', '14it126', 'female', '14it126@nitk.com', 5, ''),
...
--
CREATE TABLE IF NOT EXISTS `summarks` (
`rollno` varchar(20)
,`course` varchar(20)
,`total` decimal(32,0)
);
